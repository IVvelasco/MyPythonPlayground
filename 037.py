...
if unidade == "C":
    ...
    print(f"A temperatura de {temperatura} graus Celsius corresponde a {conversor} graus Fahrnheit")
elif unidade == "c":
    conversor = round((9 * temperatura) / 5 + 32)
    print(f"A temperatura de {temperatura} graus Celsius corresponde a {conversor} graus Fahrnheit")
elif unidade == "F":
    conversor_c = ((temperatura - 32) * 5 / 9)
    print(f"A temperatura de {temperatura} graus Fahrnheit corresponde a {conversor_c} graus Celsius")
elif unidade == "f":
    conversor_c = ((temperatura - 32) * 5 / 9)
    print(f"A temperatura de {temperatura} graus Fahrnheit corresponde a {conversor_c} graus Celsius")
else:
